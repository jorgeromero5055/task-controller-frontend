...
//       </div>
//       {/* Button Container */}
//       <div className={styles.buttonContainer} ref={filterButton}>
//         <button
//           className={styles.iconButton}
//           onClick={() => {
//             setVisibleSection('form');
...
//           <FaPlus className={styles.addIconInsideButton} />
//         </button>
//         <div tabIndex={0} onBlur={filterBlurHandler}>
//           <button
//             className={styles.iconButton}
//             name="filter"
//             onClick={() => {
...
//   const blurHandler = (e) => {
//     if (e.relatedTarget && e.currentTarget.contains(e.relatedTarget)) {
//       return; // Ignore blur event if focus remains within the container
//     } else {
//       setVisibleSection(null);
//     }
//   };
